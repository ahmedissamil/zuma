...
namespace project
{
    ...
    public partial class Form1 : Form
    {
        int lx, ly;
        Bitmap off,image2;
        int XC=600, YC=300,xs=600,ys=300,xe,ye;
        ...
        void Form1_Load(object sender, EventArgs e)
        {
            ...
            my_cruve.SetControlPoint(new Point(1120, 0));
            my_cruve.SetControlPoint(new Point(1300, 930));
            my_cruve.SetControlPoint(new Point(700, 700));

            my_cruve.SetControlPoint(new Point(-350, 1200));
            my_cruve.SetControlPoint(new Point(-1500, -50));

            my_cruve.SetControlPoint(new Point(1100, -1800));
            my_cruve.SetControlPoint(new Point(2100, 250));

            my_cruve.SetControlPoint(new Point(3100, 400));
            my_cruve.SetControlPoint(new Point(700, 2800));

            my_cruve.SetControlPoint(new Point(-2600, 1000));
            my_cruve.SetControlPoint(new Point(350, -1600));

            my_cruve.SetControlPoint(new Point(1300, -50));
            my_cruve.SetControlPoint(new Point(1700, 550));

            my_cruve.SetControlPoint(new Point(500, 750));
            my_cruve.SetControlPoint(new Point(450, 350));
        ...
        void drawscene(Graphics g2)
        {
            ...
            Bitmap bg = new Bitmap("ZZZZ.jpg");
            g2.DrawImage(bg, 0, 0, this.ClientSize.Width, this.ClientSize.Height);
            ...
            if (drawballs == 1)
            {
                ...
                g2.DrawImage(my_chara.image, my_chara.ps.X, my_chara.ps.Y, 100, 100);
